...
<body>
<nav>
    <a href="/page/home.php" style="text-decoration: none;">
        <div class="logo">Aurora Theater</div>
    </a>
    <ul>
        <li><a href="/page/home.php">Home</a></li>
        <li><a href="/pages/shows.php">Shows</a></li>
        <li><a href="/pages/login.php">Login</a></li>
        <li><a href="/pages/tickets.php">Tickets</a></li>
        <li><a href="/pages/events.php">Events</a></li>
        <li><a href="#contact">Contact</a></li>
        <li>
            <a href="/pages/cart.php">Cart (<?php echo count($_SESSION['cart']); ?>)</a>
        </li>
        <div id="search-bar">
            <form>
